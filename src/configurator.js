...
// (function() {
//
//    const configurator = new Configurator(document.querySelector('.single-configurator'));
//    configurator.init();
//
// })();
//
// function Configurator(element) {
//
//    this.element = element;
//
//    this.init = function() {
...
//             const self = this;
//             this.showStep(stepId, title, function(stepId) {
//                let choiceField = this.element.querySelector('.js-configurator-step-choice');
//                if (choiceField !== null) {
//                   let partId = choiceField.value;
//                   self.updateChoiceEnlargement(partId);
//                }
