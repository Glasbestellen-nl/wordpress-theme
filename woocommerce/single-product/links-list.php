...
<ul class="links-list large-space-below">
    ...
    <?php if ( $product->get_explanation_page_url() ) { ?>
        <li class="links-list__item"><i class="fas fa-cog links-list__icon"></i> <a href="<?php echo $product->get_explanation_page_url(); ?>" class="links-list__link" rel="nofollow" target="_blank"><?php _e( 'Uitleg stappen', 'glasbestellen' ); ?></a></li>
    <?php } ?>
    ...
    <?php if ( $product->get_info_file_url( 'assembly' ) ) { ?>
        <li class="links-list__item"><i class="fas fa-wrench links-list__icon"></i> <a href="<?php echo $product->get_info_file_url( 'assembly' ); ?>" class="links-list__link" rel="nofollow" target="_blank"><?php _e( 'Montageinstructie', 'glasbestellen' ); ?></a></li>
    <?php } ?>
