    ...
    <div class="row gallery js-bricks">
        ...
        <?php foreach ( $gallery_images as $image ) { ?>
            ...
            <div class="col-6 col-md-4 col-lg-3 js-brick">
                ...
                <a href="<?php echo $image['url']; ?>" class="gallery__item fancybox" data-fancybox="gallery" data-caption="<?php echo $image['caption']; ?>" rel="product-images" title="<?php echo $image['caption']; ?>">
