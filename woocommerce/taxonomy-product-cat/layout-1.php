			...
			<div class="col-12 col-md-12 col-lg-<?php echo ( get_field( 'review_category', 'term_' . $term_id  ) ) ? '7' : '12'; ?>">
				...
				<section class="section text space-lg-right">
					...
					if ( function_exists( 'yoast_breadcrumb' ) ) {
						yoast_breadcrumb( '<div id="breadcrumb" class="breadcrumbs space-below">', '</div>' );
					}
			...
			<div class="container">
				...
				<?php foreach ( $gallery_images as $image ) { ?>
					...
					<div class="col-6 col-md-4 col-lg-3 js-brick">
						...
						<a href="<?php echo $image['url']; ?>" class="gallery__item fancybox" data-fancybox="gallery" rel="product-images" title="<?php echo $image['caption']; ?>" data-caption="<?php echo $image['caption']; ?>">
