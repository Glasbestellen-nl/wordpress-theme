<div class="row">
   ...
   <div class="col-12 col-lg-4">
      ...
      <div class="form-group js-form-group">
         ...
         <div class="input-group">
            <input type="number" name="configuration[<?php echo $step_id; ?>][door_width]" class="form-control form-control--addon js-form-validate" value="<?php echo $configurator->get_configuration( $step_id, 'door_width' ); ?>" placeholder="mm" data-required="required" data-validation-rules='<?php echo $configurator->get_validation_rules( $step_id, 'door_width' ); ?>'>
            <div class="input-group-addon">mm</div>
         </div>
         <div class="invalid-feedback js-invalid-feedback"></div>
      </div>
