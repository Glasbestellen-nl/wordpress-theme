...
class Field_Checkbox extends Field_With_Options {
   ...
   public function get_field_html() {
      ...
      if ( ! empty( $this->_options ) ) {
         ...
         foreach ( $this->_options as $option ) {
            ...
            $html .= '<input type="checkbox" name="' . $this->get_field_name() . '[]" class="form-check__input" value="' . $option['value'] . '" ' . $checked . '/> <span class="form-check__label">' . $option['label'] . '</span>';
            $html .= '</label>';
            $count ++;
         }
         $html .= '</div>';
